...
import com.example.hibernate2.model.entity.Order;
...
import com.example.hibernate2.model.repository.UserRepository;
import lombok.Data;
...
/*
 ...
 2. Для обеих сущностей создаете Repository классы.
 ...
 */
    ...
    @PostConstruct
    private void testOfHibernateLinks() {
        User user;
        Product product;
        int numSelected;
        String str = "";
    ...
    public void detailsByUser(User user) {
    ...
    public void detailsByProduct(Product product) {
